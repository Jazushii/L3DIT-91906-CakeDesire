...
def OpenCalendar():
    ...
    main = tk.Frame(calendar, width=960, height=540)
    main.pack()
    ...
    navbar_inven = tk.Frame(navbar, width=110, height=160, bg='#FEF67F')
    ...
    navbar_calen = tk.Frame(navbar, width=110, height=160, bg='#FFC957')
    ...
    btn_inventory = tk.Button(navbar_inven, text='Inventory', font=('Segoe Print', 14), bg='#FEF67F', activebackground='#FFC957', command=switch_inventory)
    btn_inventory.pack(fill="both", expand=True)
    btn_orderlist = tk.Button(navbar_order, text='Order\nList', font=('Segoe Print', 14), bg='#FEF67F', activebackground='#FFC957', command=switch_orderlist)
    btn_orderlist.pack(fill="both", expand=True)
    btn_calendar = tk.Button(navbar_calen, text='Calendar', font=('Segoe Print', 14, 'bold'), bg='#FFC957', activebackground='#FFC957')
